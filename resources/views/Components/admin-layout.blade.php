...
<div class="min-h-full">
                ...
                <div class="flex items-center">
                    <div class="hidden md:block">
                        <div class="ml-10 flex items-baseline space-x-4">
                            @auth
                                <x-navbar href="/admin" :active="request()->is('admin')"> Home</x-navbar>
                                <x-navbar href="/admin/tasks" :active="request()->is('admin/tasks')"> Task</x-navbar>
                            @endauth
                        </div>
                    </div>
                </div>
    ...
    <header class="relative bg-white shadow">
        <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8 sm:flex sm:justify-between">
            ...
            @auth
                <x-button href="/admin/tasks/create"> Create Task</x-button>
            @endauth
        </div>
    </header>
    <main>
